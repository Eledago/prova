...
feedback::feedback(ros::NodeHandle nh)
{
    ...
    move_robot = nh.advertise<std_msgs::Bool>("/joint_states",10);


    sub = nh.subscribe("/panda_leftfinger_contactsensor_state",10,&feedback::forceCB,this);
}
...
int main(int argc, char **argv)
{
    ...
    feedback obj(nh);
    ros::Rate freq(100);
   pub1 = nh.advertise<geometry_msgs::Twist>("/panda/end_vel",10);
    HDErrorInfo error;
